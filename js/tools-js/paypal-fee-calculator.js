...
let calculateAmount = (event) => {
    ...
    <div style='min-width: 300px; border: 1px solid #CCC; border-radius: 5px; display: inline-block; margin: 5px; min-width: 260px; max-width: 400px; width: 80%;' class='result'>
